...
class:sticky={ $page.url.pathname == '/'}
	class=" top-0 z-30 flex h-16 w-full justify-center bg-opacity-90 backdrop-blur transition-all duration-100   text-primary-content  ">
	<nav class="navbar w-full">
		<div class="flex flex-1 md:gap-1 lg:gap-2">
			<div class="flex items-center gap-2 "><a href="/" aria-current="page" aria-label="Homepage"
					class="flex-0 btn btn-ghost px-2 " class:hidden={ $page.url.pathname == '/'}>
					<div class="font-title text-primary inline-flex text-lg transition-all duration-200 md:text-3xl"><span
							class="text-primary-content">Saul</span>
						<span class=" text-primary-content">Goodman</span></div>
				</a>
				</div>
