    ...
    <div class="">
          ...
          <div class="lg:px-10 lg:pb-12">
            ...
            <div class="flex w-full flex-col items-start space-y-10 lg:flex-row lg:space-x-4 lg:space-y-0">
              <div class="my-2 flex max-w-sm flex-col gap-2 text-left">
                <div class="flex gap-2"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                  Los acuerdos son escritos en Markdown</div>
                <div class="flex gap-2"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                  Almacenado en IPFS</div>
                <div class="flex gap-2"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                  Los acuerdos publicos seran NFTs intrasferibles</div>
                <div class="flex gap-2"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                  Los acuerdos privados seran firmados con Zero knoledge proofs</div>
                <!--
                  <div class="flex gap-2"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" class="inline-block h-6 w-6 stroke-current">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-4 flex flex-1 justify-center space-x-2 sm:justify-start lg:mt-6 lg:justify-start">
              <a href="/create-public" class="btn btn-ghost btn-active lg:btn-lg normal-case"><span
                  class="hidden sm:inline">Crear acuerdo publico</span>
                <span class="inline sm:hidden">Acuerdo publico</span></a>
      ...
      <div class="hero bg-base-100 text-base-content mx-auto min-h-screen max-w-md md:max-w-full">
        <div class="hero-content px-4 text-center md:px-0">
          <div id="how">
            <h2 class="mt-32 mb-2 text-4xl font-extrabold md:text-6xl">Como funciona?</h2>
            <h3 class="mb-5 text-3xl font-bold">muy sencillo, decentralizado y seguro</h3>
            <p class="mx-auto mb-5 w-full max-w-lg">No reinventemos la rueda<br />
              SaulGoodman solo agrupa tecnologias y herramientas para facilitar la creacion de acuerdos
              </p>
            ...
            <div class="mt-10 mb-20 flex flex-col lg:flex-row">
              <div class="flex w-full flex-col text-left">
                <div class=" mx-auto w-full max-w-xs flex-grow sm:max-w-md">
                  <b>Crear un acuerdo publico</b>, ejemplo terminos y condiciones de un sitio, asegurando que el mismo no puede ser modificado o adulterado por nadie.
              <ul class="steps steps-vertical">
  <li class="step">Crear contrato con markdown</li>
  <li class="step">Publicarlo en IPFS</li>
  <li class="step">Generar NFT del contrato publico</li>
  <li class="step">Compartir</li>
</ul>    
                </div>
                <div class="mt-4 flex h-16 items-start justify-center">
                  <a class="inline-block cursor-pointer rounded-md bg-indigo-600 px-4 py-3 text-center text-sm
                   font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-indigo-700" href="#public">Que es un acuerdo publico?</a>
                </div>
              </div>
              <div class="divider text-base-content/50 lg:divider-horizontal uppercase">vs</div>
              <div class="flex w-full flex-col text-left">
                <div class="mx-auto w-full max-w-xs flex-grow sm:max-w-md">
                  <b>Crear un acuerdo privado</b>, ejemplo contrato entre A y B, donde la firma de A y B puede verificarse por cualquier persona ademas de verificar que el acuerdo firmado puede ser modificado por nadie.
                  <ul class="steps steps-vertical">
                    <li class="step">Crear contrato con markdown</li>
                    <li class="step">Publicarlo en IPFS</li>
                    <li class="step">Ambas partes dejan una signature de zero knoledge</li>
                    <li class="step">El acuerdo es almacenado en IPFS</li>
                  </ul>    
                </div>
                <div class="mt-4 flex h-16 items-start justify-center">
                  <a href="#private" class="btn btn-primary">Que es un acuerdo privado?</a>
                </div>
              </div>
            </div>
      ...
      <div class="hero bg-neutral text-neutral-content min-h-screen" id="public">
      ...
      <div class="hero from-primary to-accent text-primary-content min-h-screen bg-gradient-to-br" id="private">
        <div class="hero-content mx-auto max-w-md text-center md:max-w-full">
          <div>
            <h2 class="mt-20 mb-2 text-4xl font-extrabold md:text-6xl">Contratos entre partes</h2>
            <h3 class="mb-5 text-3xl font-bold">Inmutables y firmados con zero knoledge proofs</h3>
            ...
            <div class="my-20 flex flex-col">
              <a class="btn btn-primary rounded-full" href="/create-private">CREAR CONTRATO PRIVADO</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="w-full">
            ...
            <div class="mx-auto my-2 w-full max-w-sm md:max-w-md lg:max-w-2xl">
              <div
                ...
                <pre><code>
  <span class="text-neutral-content text-opacity-40">&lt;link href=&quot;</span>https://cdn.jsdelivr.net/npm/daisyui@2.13.6/dist/full.css<span class="text-neutral-content text-opacity-40">&quot; rel=&quot;stylesheet&quot; type=&quot;text/css&quot; /&gt;</span>
  <span class="text-neutral-content text-opacity-40">&lt;script src=&quot;</span>https://cdn.tailwindcss.com<span class="text-neutral-content text-opacity-40">&quot;&gt;&lt;/script&gt;</span>
            ...
            <div class="flex flex-wrap justify-center gap-2"><a target="_blank" rel="noopener" href="/codepen"
                class="btn-outline btn gap-3 normal-case"><svg class="h-4 w-4 stroke-current" viewBox="0 0 64 64"
                  xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="2.3" stroke-linecap="round"
              ...
              <a href="/tailwindplay" class="btn-outline btn gap-3 normal-case" target="_blank" rel="noopener"><svg
                  class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33">
              ...
              <a sveltekit:prefetch href="/docs/install/" class="btn-outline btn gap-3 normal-case">
                <div class="flex"><img class="w-5" src="/logos/react.svg" alt="React" loading="lazy">
                  <img class="w-5" src="/logos/vue.svg" alt="Vue" loading="lazy">
                  <img class="w-5" src="/logos/svelte.svg" alt="Svelte" loading="lazy"></div>
                More examples
      ...
      <div class="hero bg-base-100 text-base-content mx-auto min-h-screen max-w-md md:max-w-full">
        <div class="hero-content text-center">
          <div class="w-full max-w-md">
            ...
            <p class="mx-auto mt-5 w-full max-w-lg">Pure CSS. Works on all frameworks. daisyUI can be used as a Tailwind
              CSS plugin or as an independent CSS library</p>
